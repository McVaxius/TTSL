...
const UI_STORAGE_PREFIX="ttslhud.",DEFAULT_LAYOUT_MODE="operator",DEFAULT_SHOW_DETAILS=false,DEFAULT_MAP_BOX_PX=160,DEFAULT_COMBAT_WIDTH_YALMS=20,DEFAULT_COMBAT_HEIGHT_YALMS=20,DEFAULT_TRAVEL_WIDTH_YALMS=50,DEFAULT_TRAVEL_HEIGHT_YALMS=50,LAYOUT_MODES=new Set(["classic","operator","command","matrix"]);
...
let currentAssetCatalog={jobIcons:{},maps:{},raceIcons:{},tribeIcons:{},warnings:[]},currentLayoutMode=DEFAULT_LAYOUT_MODE,selectedEntityKey="",showDetails=DEFAULT_SHOW_DETAILS;
...
function renderClient(client){
  ...
  card.append(stateSection,partySection,renderMinimapSection(client.map,client.position,"Minimap",!!client?.conditions?.inCombat,buildClientMinimapPoints(client),"YOU"),renderThreats(client.combat),renderRemoteControlSection(client,"Remote Control"));
  if(showDetails)
